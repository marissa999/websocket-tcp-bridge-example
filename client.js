...
document.getElementById('settingsForm').addEventListener('submit', (event) => {
    ...
    const middlewareHostname = document.getElementById('settingsMiddlewareHostname').value;
    const middlewarePort = document.getElementById('settingsMiddlewarePort').value;
    const endpointHostname = document.getElementById('settingsEndpointHostname').value;
    ...
    // connect to server
    connection = new MiddleWareConnect(middlewareHostname, middlewarePort, endpointHostname, endpointPort, (data) => {
...
document.getElementById('connectionForm').addEventListener('submit', (event) => {
    event.preventDefault();
    data = document.getElementById('sendMessageText').value + "\r\n";
